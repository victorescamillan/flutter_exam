...
class GalleryInitial extends GalleryState {
  ...
  List<GalleryModel> get galleryImages => [
    ...
    GalleryModel(id: 2, imagePath: 'image2.jpeg', isVisible: true, displayLocation: DisplayLocation.tabA),
    GalleryModel(id: 3, imagePath: 'image3.jpeg', isVisible: true, displayLocation: DisplayLocation.tabA),
    GalleryModel(id: 4, imagePath: 'image4.jpeg', isVisible: true, displayLocation: DisplayLocation.tabA),
    GalleryModel(id: 5, imagePath: 'image5.jpeg', isVisible: true, displayLocation: DisplayLocation.tabA),
    GalleryModel(id: 6, imagePath: 'image6.jpeg', isVisible: true, displayLocation: DisplayLocation.tabB),
    GalleryModel(id: 7, imagePath: 'image7.jpeg', isVisible: true, displayLocation: DisplayLocation.tabB),
    GalleryModel(id: 8, imagePath: 'image8.jpeg', isVisible: true, displayLocation: DisplayLocation.tabB),
